...
function App() {
    ...
    const [type, setType] = useState('upload'); // download/upload/bidirectional
    const [iterations, setIterations] = useState(1); // 1, 2, 3, 4, 5, 6 
    const [streamCount, setStreamCount] = useState(2); // 1, 2, 3, 4, 5, 6 
    const [size, setSize] = useState('5M'); // 5M, 50M, 100M, 500M, 1G , 2G
